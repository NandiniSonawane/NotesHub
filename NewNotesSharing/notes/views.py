...
def upload_notes(request):
    ...
    if request.method == 'POST':
        try:
            ...
            n = request.FILES.get('notesfile')  # Use get() to safely retrieve the file
            f = request.POST.get('filetype')
            d = request.POST.get('description')
            if b and s and n and f and d:  # Check if all required fields are present
                ...
                error = "yes"  # Some fields are missing
        except Exception as e:
            print(e)  # Print the exception for debugging
            error = "yes"  # An error occurred during notes creation
